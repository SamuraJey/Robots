...
public class GraphicsUtils {
    ...
    public static void drawRect(Graphics g, int centerX, int centerY, int diam1, int diam2) {
        g.drawRect(centerX - diam1 / 2, centerY - diam2 / 2, diam1, diam2);
    }

    public static void fillRect(Graphics g, int centerX, int centerY, int diam1, int diam2) {
        g.fillRect(centerX,centerY,diam1,diam2);
    }
}
