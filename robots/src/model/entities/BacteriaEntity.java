...
public class BacteriaEntity extends Entity {
    ...
    private final List<WorldContext.Direction> listOfDirection = List.of(WorldContext.Direction.UP,
            WorldContext.Direction.DOWN, WorldContext.Direction.LEFT, WorldContext.Direction.RIGHT);

    public BacteriaEntity(int width, int height, Point2D.Double position) {
        bacteriaHeight = height;
        bacteriaWidth = width;
        bacteriaPosition = position;
    }
    ...
    public int getBacteriaHeight() {
        return bacteriaHeight;
    }

    public int getBacteriaWidth() {
        return bacteriaWidth;
    }
